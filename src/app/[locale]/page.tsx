  ...
  const keywordClusters = [
    {
      ...
      links: [
        { label: 'CPJ 35', href: '/cpj-35' },
        { label: 'CPJ 45', href: '/cpj-45' },
        { label: 'CPJ 55', href: '/cpj-55' },
        { label: 'Ciment Portland', href: '/ciment-portland-maroc' },
        { label: 'Ciment Blanc', href: '/ciment-blanc-maroc' },
        { label: 'Ciment Hydrofuge', href: '/ciment-hydrofuge-maroc' },
    ...
    },
    {
      ...
      links: [
        ...
        { label: 'Béton Prêt à l\'Emploi', href: '/beton-pret-emploi' },
        { label: 'Devis Gratuit', href: '/devis' },
      ],
    },
    {
      title: isFr ? 'Types de Ciment' : 'Cement Types',
      links: [
        { label: 'Ciment Réfractaire', href: '/ciment-refractaire-maroc' },
        { label: 'Ciment Prise Rapide', href: '/ciment-prise-rapide-maroc' },
        { label: 'Ciment Prise Retardée', href: '/ciment-prise-retardee-maroc' },
        { label: 'Ciment Anti-Sulfates', href: '/ciment-resistant-sulfates' },
        { label: 'Mortier Ciment', href: '/mortier-ciment-maroc' },
        { label: 'Mortier-Colle', href: '/mortier-colle-ciment' },
      ],
    },
    {
      title: isFr ? 'Applications & Zones' : 'Applications & Zones',
      links: [
        ...
        { label: 'Calculateur', href: '/calculateur-ciment' },
